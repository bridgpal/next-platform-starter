...
export default function Page() {
    return (
        <div className="flex flex-col gap-6 sm:gap-12">
            ...
            <section>
                <h2 className="mb-4 text-2xl font-bold font-serif sm:text-3xl">Using next/image component</h2>
                <Markdown content={nextImageSnippet} />
                <div
                    className="mt-8 overflow-hidden border-3 border-black shadow-brutal relative max-w-screen-lg"
            ...
            <section>
                <h2 className="mb-4 text-2xl font-bold font-serif sm:text-3xl">
                    Original vs. optimized image: can you tell the difference?
                </h2>
                <Markdown content={originalVsCdnSnippet} />
                <div className="diff aspect-[3/2] border-3 border-black shadow-brutal mt-8">
