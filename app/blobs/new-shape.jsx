...
export function NewShape(props) {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full gap-2">
            <div className="text-lg font-bold font-serif">New Random Shape</div>
            <div className="bg-white border-3 border-black shadow-brutal">
                <div className="text-md w-full text-center text-black text-lg p-2 border-b-3 border-black font-serif">
