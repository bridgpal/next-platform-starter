...
async function RandomWikiArticle() {
    ...
    return (
        <div className="bg-white text-black card my-6 max-w-2xl">
            <div className="card-title text-3xl font-serif px-8 pt-8">{content.title}</div>
            <div className="card-body py-4">
                <div className="text-lg font-bold font-serif">{content.description}</div>
